...
@Autonomous(name="AutoClose3", group="Linear Opmode")
//Disabled
public class BlueAutonoClose3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        rightDrive.setTargetPosition(950);
        leftMotor.setTargetPosition(950);
        rightMotor.setTargetPosition(950);
